...
De Laet [-@DeLaet2017] correctly identifies a corner case in which our algorithm will not reconstruct every equally-parsimonious character reconstruction.  Below is a simplified version of his example:
...
This has no effect on tree scoring, but may be relevant if internal nodal reconstructions are significant.
