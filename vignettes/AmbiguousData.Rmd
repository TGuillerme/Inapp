...
```{R fully amb, echo=FALSE, fig.width=8, fig.height=4}
setPar()
...
```{R fully amb - absent, echo=FALSE, fig.width=8, fig.height=4}
setPar()
...
```{R certain homology, echo=FALSE, fig.width=4, fig.height=4}
setPar(c(1, 1))
...
```{R uncertain homology, echo=FALSE, fig.width=4, fig.height=4}
setPar(c(1, 1))
...
```{R possible homoplasy in parent character, echo=FALSE, fig.width=4, fig.height=4}
setPar(c(1, 1))
vignettePlot(ape::read.tree(text="((a, (i1, i2)), (b, (c, (d, (e, (f, (g, h)))))));"),
...
[Return to index](Index.html) | [Coding neomorphic characters](Neomorphics.html) | [Further coding considerations](CodingData.html)
