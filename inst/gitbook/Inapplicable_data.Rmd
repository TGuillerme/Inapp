...
```{r, echo = FALSE, fig.width = 7.1, fig.height = 7.1, fig.cap="Node reconstructions after AccTran or DelTran` optimizations"}
...
```{r, echo=FALSE, fig.width=6, fig.height=4, fig.cap="Possible resolutions for bold region of tree"}
setPar(c(2, 3))
...
```{r, echo=FALSE, fig.width=7.1, fig.height=2.8, fig.cap="Reconstructed nodal states of a character hierarchy"}
...
Contrast('0001111111111', "Appendages:", ap, header=TRUE, y=0.5)
Contrast('---0011112222', "Appendage termination:", c("Blunt", "Claw", "Sucker"), y=1.8)
Contrast('-----1122----', "Claw morphology:", c('', "Smooth", "Serrated"), y=1.2)
Contrast('---------1122', "Sucker morphology:", c('', "Round", "Polygonal"), y=1.2)
