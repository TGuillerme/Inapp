...
edge_col <- Inapp::brewer[[2]][c(1,1,1,1,rep(2, 10))]
...
edge_col <- Inapp::brewer[[2]][c(1,1,1,1,rep(2, 14))]
...
edge_col <- redBlue[c(1,1,1,1,rep(2, 10))]
...
down_labels <- paste("1:", c(0, 1, '01')[c(1,3,2,3,2,2,3,1,3)])
up_labels <- paste("2:",   c(0,0, rep(1, length(char) - 3)))
node_labels <- paste(down_labels, up_labels, sep = "\n")
...
#vignettePlot(tree, rev(char), na=FALSE, passes=0, legend.pos='none')
