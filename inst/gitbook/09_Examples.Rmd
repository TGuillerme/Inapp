...
```{R OptimalCaterpillar, echo = FALSE, fig.height=4, fig.width=8}
...
```{R OptimalCaterpillarTwice, echo = FALSE, fig.height=4, fig.width=8}
...
```{R GoloA, echo = FALSE, fig.height=4, fig.width=8}
...
```{R GoloB, echo = FALSE, fig.height=4, fig.width=8}
...
```{R GoloC, echo = FALSE, fig.height=4, fig.width=8}
...
```{R GoloD, echo = FALSE, fig.height=4, fig.width=8}
