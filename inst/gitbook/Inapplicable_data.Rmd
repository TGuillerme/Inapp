...
## Why Extra State coding doesn't work
...
In other words and following our "colour of the tail" character, extra applicable regions imply independent appearances of the tail somewhere in the node's descendants.
...
<!--chapter:end:07_Neomorphics.Rmd-->
...
rownames(mDep) <- c("Tail: (0), absent; (1), present.",
                    "Tail margin: (0), smooth; (1), serrated.",
                    "Tail colour: (0), red; (1), blue.")
knitr::kable(mDep, caption="Recommended coding for unknown states")
```
