...
The alternative is to allow loss to cost less than gain:
...
```{R Sankoff is still no good, echo=FALSE, fig.height=5, fig.width=8}
sankTree <- ape::read.tree(text="(((((a, b), c), dX), eX), (fX, (gX, (p, (q, r)))));")
vignettePlot(sankTree, '1110000888', na=FALSE, legend='none')
legend('bottomleft', "Nope")
```
